...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "Query.plot2D":
		if e.complexity.Query.Plot2d == nil {
			break
		}

		args, err := ec.field_Query_plot2D_args(context.TODO(), rawArgs)
		if err != nil {
			return 0, false
		}
...
func (ec *executionContext) field_Query_plot2D_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	var err error
	args := map[string]interface{}{}
...
func (ec *executionContext) _Query_plot2D(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	defer func() {
		if r := recover(); r != nil {
	...
	args, err := ec.field_Query_plot2D_args(ctx, rawArgs)
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
	}
	...
	for i, field := range fields {
		...
		case "plot2D":
			...
			innerFunc := func(ctx context.Context) (res graphql.Marshaler) {
				...
				res = ec._Query_plot2D(ctx, field)
				return res
			}
...
func (ec *executionContext) unmarshalNExpression2githubᚗcomᚋcstevenson98ᚋgraphᚑcalcᚋserverᚋgraphᚋmodelᚐExpression(ctx context.Context, v interface{}) (model.Expression, error) {
